    ...
    stories: [
      {
        ...
        fr: "À Jinja, le Nil ne donne pas tout de suite l'impression d'un grand fleuve qui traversera l'Afrique. Il s'éloigne du lac Victoria avec une assurance tranquille, entre les jardins, les pirogues et les rives verdoyantes. Pourtant, cette eau va ensuite filer vers le nord, puis bien plus loin, jusqu'en Égypte.\n\nLe meilleur moment est souvent le plus simple : s'asseoir près de l'eau et regarder le courant prendre son chemin. Des bateaux emmènent les visiteurs sur le fleuve, des pêcheurs travaillent non loin, et les oiseaux passent au-dessus des roseaux. On comprend alors pourquoi ce lieu attire autant les curieux que les habitants de la région.\n\nJinja a aussi l'énergie des villes de rivière. Les rapides en aval ont fait sa réputation auprès des amateurs de rafting et de kayak, tandis que les terrasses au bord de l'eau invitent à ralentir. On peut choisir l'adrénaline ou une promenade douce; dans les deux cas, le Nil reste toujours le véritable personnage de la journée.\n\nEn repartant, on garde moins l'idée d'un point sur une carte que celle d'un départ. Ici, un fleuve immense commence une très longue histoire, sans bruit spectaculaire, simplement en glissant hors du lac.",
        en: "In Jinja, the Nile does not immediately look like the great river that will cross Africa. It leaves Lake Victoria with quiet confidence, passing gardens, canoes, and green banks. Yet this water will flow north and then much farther on, all the way to Egypt.\n\nThe best moment is often the simplest: sitting by the water and watching the current find its course. Boats take visitors onto the river, fishers work nearby, and birds pass above the reeds. It becomes easy to see why this place draws both curious travellers and people from the region.\n\nJinja also has the energy of a river town. The rapids downstream have made it famous with rafting and kayaking enthusiasts, while waterside terraces invite you to slow down. You can choose adrenaline or a gentle walk; either way, the Nile remains the true character of the day.\n\nWhen you leave, what stays with you is less a point on a map than a sense of departure. Here, a mighty river begins a very long story, not with a spectacle, but by simply slipping out of the lake."
      },
      {
        title: { fr: "Bwindi, la forêt des gorilles des montagnes", en: "Bwindi, the Mountain Gorilla Forest" },
        fr: "Dans le sud-ouest de l'Ouganda, Bwindi semble d'abord être un mur de vert. La forêt grimpe sur les collines, dense, humide, traversée de sentiers qui disparaissent vite sous les feuilles. C'est un paysage qui demande de prendre son temps avant de se laisser comprendre.\n\nUne marche avec les pisteurs commence souvent dans le calme, puis avec le bruit des branches, des pas dans la terre mouillée et des oiseaux qu'on entend sans toujours les voir. Les équipes suivent les traces des gorilles des montagnes et connaissent les habitudes des familles habituées à la présence humaine. La randonnée peut être courte ou demander de l'effort : la forêt décide du rythme.\n\nPuis le groupe apparaît, parfois derrière un rideau de feuillage. Un dos argenté reste immobile, une mère surveille son petit, les jeunes se chamaillent ou grimpent à quelques mètres. Pendant l'heure de rencontre autorisée, le silence vient naturellement; on est invité dans leur monde, pas l'inverse.\n\nBwindi laisse une impression particulière parce qu'elle ne se résume pas aux gorilles. En sortant du sous-bois, on emporte aussi l'odeur de pluie, la profondeur du vert et le respect dû à une forêt qui protège encore une vie extraordinairement fragile.",
        en: "In southwestern Uganda, Bwindi first looks like a wall of green. The forest climbs the hills, dense and damp, crossed by paths that quickly disappear beneath leaves. It is a landscape that asks you to take your time before it reveals itself.\n\nA walk with trackers often begins quietly, then fills with snapping branches, footsteps in wet earth, and birds you hear without always seeing. Teams follow the signs of mountain gorillas and know the habits of the families accustomed to human presence. The trek may be short or demanding: the forest sets the pace.\n\nThen a group appears, sometimes behind a curtain of foliage. A silverback sits still, a mother watches her young, and juveniles squabble or climb a few metres away. During the permitted hour together, silence comes naturally; you are being welcomed into their world, not the other way around.\n\nBwindi stays with you because it is more than its gorillas. Leaving the undergrowth, you carry the scent of rain, the depth of its green, and a respect for a forest that still shelters extraordinarily fragile life."
      },
      {
        title: { fr: "Les chutes Murchison, où le Nil explose", en: "Murchison Falls, Where the Nile Explodes" },
        fr: "À Murchison Falls, le Nil arrive large et puissant, puis se trouve soudain serré dans une fente rocheuse si étroite qu'il semble ne plus avoir de place pour passer. L'eau se précipite, frappe les parois et jaillit dans un grondement continu. De près, on ne l'entend pas seulement : on le sent dans la poitrine.\n\nUn sentier mène vers les points de vue au sommet des chutes. La brume colle un peu à la peau, l'arc-en-ciel apparaît parfois au-dessus de l'écume, et chacun s'arrête pour regarder l'eau recommencer le même geste immense. C'est un spectacle brut, sans mise en scène, qui rend le fleuve presque irréel.\n\nEn contrebas, le parc national de Murchison Falls s'ouvre sur des plaines et des rives où la vie sauvage est bien présente. Depuis un bateau sur le Nil, on peut apercevoir des hippopotames, des crocodiles et des éléphants qui viennent boire. Un safari dans les savanes voisines prolonge cette impression d'un territoire généreux et vivant.\n\nMais ce sont les chutes qui donnent au lieu sa mémoire. Après les avoir vues, le Nil n'est plus seulement une ligne bleue sur une carte : c'est une force qui trouve son passage, même lorsqu'il paraît impossible.",
        en: "At Murchison Falls, the Nile arrives broad and powerful, then suddenly finds itself squeezed through a rocky gap so narrow that it seems to have no room left to pass. The water rushes through, strikes the walls, and bursts out in an unbroken roar. Up close, you do not only hear it; you feel it in your chest.\n\nA path leads to viewpoints above the falls. Mist settles on your skin, a rainbow sometimes appears above the spray, and everyone pauses to watch the water repeat the same immense movement. It is a raw spectacle with no need for staging, making the river feel almost unreal.\n\nBelow, Murchison Falls National Park opens onto plains and riverbanks full of wildlife. From a boat on the Nile, you may spot hippos, crocodiles, and elephants coming down to drink. A safari in the neighbouring savannah extends the feeling of being in a generous, living landscape.\n\nYet it is the falls that give the place its lasting image. Once you have seen them, the Nile is no longer just a blue line on a map: it is a force that finds a way through, even when the way seems impossible."
      },
      {
        title: { fr: "Le lac Bunyonyi, le plus profond d'Ouganda", en: "Lake Bunyonyi, Uganda's Deepest Lake" },
        fr: "Le lac Bunyonyi apparaît entre des collines cultivées comme une respiration calme après les routes sinueuses du sud-ouest. Ses nombreuses îles se posent sur l'eau sombre, tandis que les pentes autour du lac dessinent des parcelles vertes et des villages accrochés au relief.\n\nIci, on n'est pas obligé de faire grand-chose pour se sentir ailleurs. Une pirogue glisse sans moteur, les rames font à peine bouger la surface, et les conversations portent d'une rive à l'autre. Sur l'eau, le paysage change doucement à chaque virage : une île, une maison, un chemin qui descend vers un petit embarcadère.\n\nLe lac fait partie de la vie quotidienne autant que du voyage. Des habitants le traversent pour aller au marché, rejoindre l'école ou transporter quelques marchandises. Les visiteurs peuvent marcher sur les hauteurs, pagayer entre les îles ou simplement suivre les reflets qui passent du bleu au gris selon le ciel.\n\nBunyonyi n'essaie pas d'impressionner par le bruit. Sa beauté tient à cette lenteur, à la présence de l'eau et aux collines qui l'entourent. On le quitte souvent avec l'envie de garder encore un peu ce silence.",
        en: "Lake Bunyonyi appears among cultivated hills like a calm breath after the winding roads of southwestern Uganda. Its many islands rest on dark water, while the slopes around the lake form green plots and villages clinging to the land.\n\nHere, you do not have to do much to feel far away. A canoe glides without an engine, the paddles barely stir the surface, and conversations carry from one bank to another. On the water, the view changes gently with every turn: an island, a house, a path leading down to a small landing.\n\nThe lake is part of everyday life as much as it is part of a journey. Residents cross it to reach the market or school, or to carry a few goods. Visitors can walk the high paths, paddle between the islands, or simply watch reflections shift from blue to grey with the sky.\n\nBunyonyi does not try to impress through noise. Its beauty lies in its slowness, in the presence of the water, and in the hills that hold it. People often leave wishing they could keep that quiet a little longer."
      },
      {
        title: { fr: "Kidepo Valley, la savane du bout du monde", en: "Kidepo Valley, the Savannah at the End of the World" },
        fr: "Rejoindre Kidepo demande du temps, et c'est déjà une part du voyage. Au nord-est de l'Ouganda, les routes s'éloignent des villes les plus animées et le paysage s'ouvre peu à peu. Quand la vallée apparaît, vaste entre les montagnes, on a vraiment l'impression d'être arrivé au bout de quelque chose.\n\nLa savane semble ne jamais finir. Des herbes hautes bougent sous le vent, des termitières ponctuent la plaine, et les troupeaux d'animaux se dessinent au loin avant de devenir plus nets. Girafes, buffles, éléphants et antilopes font partie de ce décor immense, où le regard peut porter très loin.\n\nKidepo est aussi lié au Karamoja et aux communautés qui vivent dans cette région de grands espaces. En dehors du parc, les marchés, les troupeaux et les silhouettes des montagnes rappellent que ce paysage n'est pas vide : il est habité, travaillé et traversé par des traditions vivantes.\n\nLe soir, la lumière basse transforme la vallée en bandes d'or et d'ombre. Dans ce silence loin des itinéraires les plus fréquentés, Kidepo donne surtout le sentiment précieux d'avoir laissé derrière soi le monde pressé.",
        en: "Getting to Kidepo takes time, and that is already part of the journey. In northeastern Uganda, the roads move away from the busiest towns and the landscape gradually opens up. When the valley appears, broad between the mountains, you truly feel you have reached the end of something.\n\nThe savannah seems endless. Tall grasses move in the wind, termite mounds punctuate the plain, and herds of animals begin as distant shapes before coming into focus. Giraffes, buffaloes, elephants, and antelopes belong to this immense setting, where your gaze can travel a long way.\n\nKidepo is also connected to Karamoja and the communities who live in this region of wide-open land. Beyond the park, markets, herds, and mountain silhouettes are a reminder that this landscape is not empty: it is lived in, worked, and crossed by living traditions.\n\nIn the evening, low light turns the valley into bands of gold and shadow. In this quiet place far from the busiest routes, Kidepo offers the rare feeling of having left the hurried world behind."
      },
      {
        title: { fr: "Les îles Ssese, l'archipel du lac Victoria", en: "The Ssese Islands, Lake Victoria's Archipelago" },
        fr: "Sur le lac Victoria, les îles Ssese font oublier la proximité de Kampala. Le trajet en ferry suffit à changer le rythme : l'horizon s'élargit, le vent arrive du large, et les maisons de la ville laissent place aux plages, aux palmiers et aux chemins de terre.\n\nL'archipel ne ressemble pas à une carte postale figée. Sur les rives, des pêcheurs préparent leurs filets et des bateaux partent tôt sur le lac. Dans les villages, la vie suit les arrivées de bateaux, les petites boutiques, l'école et les discussions à l'ombre. C'est cette activité tranquille qui donne aux îles leur caractère.\n\nOn peut passer une journée à marcher le long d'une plage, lire sous les palmes ou observer le lac changer de couleur. D'autres préfèrent rejoindre une baie en bateau ou découvrir une communauté de pêcheurs. Rien ne presse vraiment, sauf parfois le dernier ferry.\n\nLes Ssese sont un rappel que le lac Victoria est bien plus qu'une étendue d'eau vue depuis la rive. Entre les îles, il devient une route, un lieu de travail et un espace où l'on peut enfin respirer plus lentement.",
        en: "On Lake Victoria, the Ssese Islands make Kampala feel far away. The ferry ride is enough to change the pace: the horizon widens, wind comes in from the open water, and city buildings give way to beaches, palms, and dirt paths.\n\nThe archipelago is not a frozen postcard. On the shore, fishers prepare their nets and boats leave early for the lake. In the villages, life follows boat arrivals, small shops, school, and conversations in the shade. That quiet activity is what gives the islands their character.\n\nYou can spend a day walking along a beach, reading beneath the palms, or watching the lake change colour. Others prefer to reach a bay by boat or visit a fishing community. Nothing is in much of a hurry, except perhaps the last ferry.\n\nThe Ssese Islands are a reminder that Lake Victoria is much more than a stretch of water seen from shore. Between the islands, it becomes a road, a workplace, and a place where you can finally breathe more slowly."
      },
      {
        title: { fr: "Sipi Falls, sur la route du café", en: "Sipi Falls, on the Coffee Road" },
        fr: "Près des pentes du mont Elgon, Sipi Falls se découvre dans un air plus frais, au milieu des jardins et des collines. L'eau descend en plusieurs chutes, parfois visible de loin comme un trait blanc sur la paroi verte. Le paysage invite tout de suite à marcher.\n\nLes sentiers passent par des villages, des bananeraies et des points de vue qui donnent sur la vallée. Après une montée, entendre la cascade avant de la voir rend l'arrivée encore plus belle. Selon le chemin choisi, on se rapproche du pied des chutes ou on les regarde tomber depuis les hauteurs.\n\nLa région est également connue pour son café arabica. Autour de Sipi, des familles cultivent le café sur les pentes fertiles du mont Elgon, et une visite peut suivre les grains depuis la cerise rouge jusqu'à la tasse. Le parfum du café fraîchement torréfié reste souvent associé au bruit de l'eau.\n\nÀ Sipi, la randonnée et le café se répondent naturellement : l'un fait découvrir les reliefs, l'autre les mains qui les cultivent. C'est un endroit qui se savoure lentement, entre une pause chaude et le souffle frais des chutes.",
        en: "Near the slopes of Mount Elgon, Sipi Falls comes with cooler air, among gardens and hills. Water drops in several cascades, sometimes visible from afar as a white line on the green cliff. The landscape immediately makes you want to walk.\n\nThe trails pass villages, banana groves, and viewpoints over the valley. After a climb, hearing the waterfall before seeing it makes the arrival even better. Depending on the path, you can reach the foot of the falls or watch them plunge from above.\n\nThe region is also known for Arabica coffee. Around Sipi, families grow coffee on Mount Elgon's fertile slopes, and a visit can follow the beans from red cherry to cup. The scent of freshly roasted coffee often stays linked to the sound of the water.\n\nAt Sipi, hiking and coffee belong together naturally: one reveals the shape of the land, the other the hands that cultivate it. It is a place to savour slowly, between a warm break and the cool breath of the falls."
      },
      {
        title: { fr: "Kibale, la forêt aux chimpanzés", en: "Kibale, the Chimpanzee Forest" },
        fr: "Dans la forêt de Kibale, le matin commence rarement en silence. Il y a les appels lointains, les insectes, les feuilles qui frémissent et, parfois, le cri puissant d'un chimpanzé qui traverse les arbres. Avant même d'en voir un, on sent que la forêt est pleine de mouvements cachés.\n\nLe pistage se fait à pied, derrière un guide attentif aux sons et aux traces. Le sentier peut être boueux, la végétation dense, et l'attente fait partie de l'expérience. Puis les chimpanzés se signalent : une branche bouge, une silhouette passe au-dessus, un groupe s'appelle avant de continuer sa route.\n\nLes observer ne ressemble pas à une scène préparée. Ils peuvent manger, se toiletter, jouer ou disparaître brusquement dans la canopée. Kibale abrite aussi beaucoup d'autres primates, des oiseaux et une foule de petites vies que l'on remarque seulement en ralentissant.\n\nQuand la forêt se referme derrière le dernier regard, on emporte surtout ses sons. Kibale rappelle que la nature la plus forte n'est pas toujours celle qui se montre immédiatement, mais celle qui continue de vivre tout autour de nous.",
        en: "In Kibale Forest, morning rarely begins in silence. There are distant calls, insects, trembling leaves, and sometimes the powerful cry of a chimpanzee carrying through the trees. Before seeing one, you already sense that the forest is full of hidden movement.\n\nTracking happens on foot, behind a guide attentive to sounds and signs. The path may be muddy, the vegetation dense, and waiting is part of the experience. Then the chimpanzees give themselves away: a branch moves, a shape passes overhead, or a group calls to one another before moving on.\n\nWatching them does not feel like a staged scene. They may eat, groom one another, play, or suddenly disappear into the canopy. Kibale also shelters many other primates, birds, and a host of smaller lives that you only notice when you slow down.\n\nWhen the forest closes behind your final glimpse, it is its sounds you carry with you. Kibale is a reminder that the strongest nature is not always what appears at once, but what continues to live all around us."
      }
    ]
  },
  tradition: {
