...
const translations = {
  ...
  t1_1_exercise: { fr: "Regardez ces mots : nation, information, animal, hôpital, télévision. Devinez pour chacun : est-ce proche de l'anglais, ou totalement différent à l'oral ? Puis dites-les à voix haute. Bonus : essayez de dire « vous avez » en faisant la liaison.", en: "Look at these words: nation, information, animal, hôpital, télévision. Guess for each: close to English, or totally different out loud? Then say them aloud. Bonus: try saying \"vous avez\" using the liaison." },
