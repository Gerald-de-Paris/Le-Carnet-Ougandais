...
const translations = {
  ...
  t1_hero_desc: {
    fr: "Des sons français à vos premiers échanges : prononcer, saluer, donner une instruction et répondre simplement.",
    en: "From French sounds to your first exchanges: pronounce, greet, give an instruction, and answer simply."
  },
  t1_next_label: { fr: "→ Suite :", en: "→ Next:" },
  t1_next_link: { fr: "Track 2 — Core Grammar", en: "Track 2 — Core Grammar" },

  t1_1_title: { fr: "1.1 Hello, French!", en: "1.1 Hello, French!" },
  t1_2_title: { fr: "1.2 Les voyelles qui changent tout", en: "1.2 Vowels That Change Everything" },
  t1_3_title: { fr: "1.3 Bonjour et au revoir", en: "1.3 Say Hello & Goodbye Like a Local" },
  t1_4_title: { fr: "1.4 Donner des instructions simples", en: "1.4 Giving Simple Commands" },
  t1_5_title: { fr: "1.5 Oui, non et si", en: "1.5 Yes, No & Everything in Between" },
  t1_1_heading: { fr: "Hello, French!", en: "Hello, French!" },
  t1_2_heading: { fr: "Vowels That Change Everything", en: "Vowels That Change Everything" },
  t1_3_heading: { fr: "Say Hello & Goodbye Like a Local", en: "Say Hello & Goodbye Like a Local" },
  t1_4_heading: { fr: "Giving Simple Commands", en: "Giving Simple Commands" },
  t1_5_heading: { fr: "Yes, No, and Everything In Between", en: "Yes, No, and Everything In Between" },
  t1_1_alpha_caption: { fr: "L'alphabet français", en: "The French alphabet" },
  t1_1_alpha_letter: { fr: "Lettre", en: "Letter" },
  t1_1_alpha_sound: { fr: "Nom français / prononciation", en: "French name / pronunciation" },

  // 1.1 — Hello, French!
  t1_1_obj: { fr: "À la fin de cette leçon, vous pouvez épeler votre nom et prononcer quelques mots français familiers avec confiance.", en: "By the end of this lesson, you can spell your name and pronounce a few familiar French words with confidence." },
  t1_1_hook: { fr: "Bienvenue ! On commence par les sons, parce qu'avant de faire une phrase, il faut oser la dire. Beaucoup de mots français ressemblent à l'anglais à l'écrit ; aujourd'hui, vous apprenez à leur donner une voix française.", en: "Welcome! We start with sounds, because before you make a sentence, you need to feel brave enough to say it. Many French words look like English in writing; today, you learn to give them a French voice." },
  t1_1_c1_title: { fr: "L'alphabet d'abord", en: "The alphabet first" },
  t1_1_c1_text: { fr: "Les 26 lettres sont les mêmes qu'en anglais, mais leurs noms changent. C'est très utile pour épeler votre nom, une adresse ou un mot que l'autre personne ne comprend pas.", en: "The 26 letters are the same as in English, but their names change. This is useful for spelling your name, an address, or a word the other person does not understand." },
  t1_1_alpha_note: { fr: "Les aides de prononciation sont approximatives. Le R français se fait au fond de la bouche, sans le rouler comme en espagnol. Le H ne se prononce pas dans les mots ordinaires.", en: "Pronunciation guides are approximate. The French R is made at the back of the mouth, not rolled like Spanish. H is not pronounced in ordinary words." },
  t1_1_c2_title: { fr: "Les mots-cousins", en: "Cognates: words you almost know" },
  t1_1_c2_text: { fr: "nation, restaurant, information : vous connaissez déjà le sens de beaucoup de mots. Le travail, maintenant, c'est de les dire avec un rythme français.", en: "nation, restaurant, information: you already know many meanings. The work now is to say them with a French rhythm." },
  t1_1_c3_title: { fr: "Le rythme français", en: "French rhythm" },
  t1_1_c3_text: { fr: "En français, le rythme est assez régulier. On ne frappe pas très fort une syllabe au milieu du mot ; la voix avance doucement vers la fin du groupe.", en: "In French, the rhythm is fairly even. You do not hit one middle syllable very hard; your voice moves gently toward the end of the group." },
  t1_1_c4_title: { fr: "Une première liaison", en: "Your first liaison" },
  t1_1_c4_text: { fr: "Parfois, une consonne finale normalement muette se prononce devant une voyelle. Dans vous allez, le s de vous sonne comme z : vous‿allez.", en: "Sometimes a normally silent final consonant is pronounced before a vowel. In vous allez, the s in vous sounds like z: vous‿allez." },
  t1_1_ex1: { fr: "nation → aide approximative : na-syon", en: "nation → approximate guide: na-syon" },
  t1_1_ex2: { fr: "restaurant → aide approximative : res-to-ran", en: "restaurant → approximate guide: res-to-rahn" },
  t1_1_ex3: { fr: "information → aide approximative : an-for-ma-syon", en: "information → approximate guide: an-for-ma-syon" },
  t1_1_ex4: { fr: "vous allez → liaison : vous‿allez", en: "vous allez → liaison: vous‿allez" },
  t1_1_ex5: { fr: "les idées → liaison : les‿idées", en: "les idées → liaison: les‿idées" },
  t1_1_ex6: { fr: "C'est vraiment bon.", en: "C'est vraiment bon. — It's really good." },
  t1_1_exercise: { fr: "Écoutez puis répétez les exemples. Ensuite, classez ces mots en deux groupes : mots faciles à reconnaître et mots plus surprenants à l'oral : nation, information, animal, hôpital, télévision. Dites-les à voix haute.", en: "Listen and repeat the examples. Then sort these words into two groups: easy-to-recognise words and words that sound more surprising aloud: nation, information, animal, hôpital, télévision. Say them out loud." },
  t1_1_tryit: { fr: "Situation réelle : quelqu'un vous demande votre nom. Épelez votre prénom en français, puis épellez le nom de votre ville. Si vous êtes en classe, faites-le avec un partenaire ; seul(e), répondez aux deux rôles.", en: "Real situation: someone asks for your name. Spell your first name in French, then spell your city. If you are in class, do it with a partner; if you are alone, read both roles." },

  // 1.2 — Vowels That Change Everything
  t1_2_obj: { fr: "À la fin de cette leçon, vous pouvez reconnaître et prononcer plusieurs voyelles françaises importantes.", en: "By the end of this lesson, you can recognise and pronounce several important French vowel patterns." },
  t1_2_hook: { fr: "Maintenant que vous avez rencontré les sons du français, regardons les voyelles qui donnent tout de suite une couleur française à vos mots.", en: "Now that you have met the sounds of French, let's look at the vowels that quickly give your words a French colour." },
  t1_2_expl: { fr: "Les accents vous aident à choisir le son : é est fermé, comme dans été ; è et ê sont plus ouverts, comme dans père et être. Les voyelles nasales se prononcent avec l'air qui passe un peu par le nez : an/en, on, in/ain, un. Ne prononcez pas un n fort à la fin. Oi se dit comme dans moi. Ui n'est pas simplement “wi” : commencez avec les lèvres de u, puis glissez vers i, comme dans huit et fruit.", en: "Accents help you choose the sound: é is closed, as in été; è and ê are more open, as in père and être. Nasal vowels are pronounced with some air passing through the nose: an/en, on, in/ain, un. Do not pronounce a strong final n. Oi sounds like moi. Ui is not simply “wee”: start with the lip position for French u, then glide toward i, as in huit and fruit." },
  t1_2_ex1: { fr: "été / être — deux sons de e à comparer", en: "été / être — two e sounds to compare" },
  t1_2_ex2: { fr: "élève / préféré — écoutez les é et è", en: "élève / préféré — listen for é and è" },
  t1_2_ex3: { fr: "père / mère — le son è est ouvert", en: "père / mère — the è sound is open" },
  t1_2_ex4: { fr: "pain, vin, bon, un — voyelles nasales", en: "pain, vin, bon, un — nasal vowels" },
  t1_2_ex5: { fr: "moi, voiture — oi ; huit, fruit — ui", en: "moi, voiture — oi; huit, fruit — ui" },
  t1_2_exercise: { fr: "Classez les mots par son : an/en, on, in/ain, un, oi, ui. Mots : pain, maison, bonjour, lundi, enfant, matin, moi, huit, fruit. Puis lisez chaque groupe à voix haute.", en: "Sort the words by sound: an/en, on, in/ain, un, oi, ui. Words: pain, maison, bonjour, lundi, enfant, matin, moi, huit, fruit. Then read each group aloud." },
  t1_2_tryit: { fr: "Mini-défi : choisissez quatre mots de la liste. Écoutez, répétez, puis dites-les sans regarder. Votre but n'est pas la perfection : c'est d'entendre la différence et d'oser produire le son.", en: "Mini-challenge: choose four words from the list. Listen, repeat, then say them without looking. Your goal is not perfection: it is to hear the difference and dare to make the sound." },

  // 1.3 — Say Hello & Goodbye Like a Local
  t1_3_obj: { fr: "À la fin de cette leçon, vous pouvez saluer quelqu'un, demander comment il va, vous présenter et dire au revoir poliment.", en: "By the end of this lesson, you can greet someone, ask how they are, introduce yourself, and say goodbye politely." },
  t1_3_hook: { fr: "Quand ces sons commencent à devenir familiers, vous êtes prêt(e) pour votre premier vrai échange en français : dire bonjour, être poli(e), et partir sur une bonne impression.", en: "Once these sounds start to feel familiar, you are ready for your first real French exchange: saying hello, being polite, and leaving a good impression." },
  t1_3_expl: { fr: "Le français utilise deux façons courantes de dire “you” : tu pour les situations familières, et vous pour les situations formelles, respectueuses ou au pluriel. Dans le doute, utilisez vous. Dites bonjour pendant la journée, bonsoir le soir, et salut avec des amis ou des personnes de votre âge dans une situation détendue. Bonne nuit se dit quand quelqu'un va dormir, pas comme un au revoir normal le soir. Pour dire d'où vous venez, utilisez je suis + nationalité : je suis ougandais / ougandaise. Les langues sont masculines et sans majuscule : le français, l'anglais.", en: "French uses two common ways of saying “you”: tu for familiar situations and vous for formal, respectful, or plural situations. When in doubt, use vous. Use bonjour during the day, bonsoir in the evening, and salut with friends or people your age in relaxed situations. Bonne nuit means “good night” when someone is going to sleep, not a normal evening goodbye. To say where you are from, use je suis + nationality: je suis ougandais / ougandaise. Languages are masculine and not capitalised: le français, l'anglais." },
  t1_3_ex1: { fr: "Bonjour ! Comment allez-vous ? / Comment vas-tu ?", en: "Bonjour! Comment allez-vous? / Comment vas-tu? — Hello! How are you?" },
  t1_3_ex2: { fr: "Très bien, merci, et vous ? / Pas mal, merci, et toi ? / Comme ci, comme ça.", en: "Très bien, merci, et vous? / Pas mal, merci, et toi? / Comme ci, comme ça. — Very well / Not bad / So-so." },
  t1_3_ex3: { fr: "Je suis ougandais(e). Il est canadien, elle est canadienne.", en: "Je suis ougandais(e). Il est canadien, elle est canadienne. — I am Ugandan. He is Canadian; she is Canadian." },
  t1_3_ex4: { fr: "l'anglais, le français, l'espagnol", en: "l'anglais, le français, l'espagnol — English, French, Spanish" },
  t1_3_ex5: { fr: "Enchanté(e). Merci beaucoup. De rien.", en: "Enchanté(e). Merci beaucoup. De rien. — Nice to meet you. Thank you very much. You're welcome." },
  t1_3_ex6: { fr: "Au revoir. À bientôt. Bonne nuit.", en: "Au revoir. À bientôt. Bonne nuit. — Goodbye. See you soon. Good night." },
  t1_3_exercise: { fr: "Choisissez la bonne option : tu ou vous ? 1) un professeur ; 2) un ami proche ; 3) deux personnes ; 4) un inconnu dans un bureau. Ensuite, lisez le mini-dialogue avec la bonne forme : Bonjour, comment ___ allez ? / Très bien, merci.", en: "Choose the right option: tu or vous? 1) a teacher; 2) a close friend; 3) two people; 4) a stranger in an office. Then read the mini-dialogue with the right form: Bonjour, comment ___ allez? / Très bien, merci." },
  t1_3_tryit: { fr: "Rencontre réelle : deux personnes se rencontrent pour la première fois. Saluez, demandez comment l'autre personne va, répondez, donnez votre nom, dites d'où vous venez, puis dites au revoir. Avec un partenaire, jouez les deux rôles ; seul(e), lisez les deux voix.", en: "Real meeting: two people meet for the first time. Greet, ask how the other person is, respond, give your name, say where you are from, then say goodbye. With a partner, act both roles; alone, read both voices." },

  // 1.4 — Giving Simple Commands
  t1_4_obj: { fr: "À la fin de cette leçon, vous pouvez comprendre et donner quelques instructions simples en français.", en: "By the end of this lesson, you can understand and give a few simple instructions in French." },
  t1_4_hook: { fr: "Après les salutations, vous allez entendre beaucoup de petites instructions : écoutez, répétez, regardez. Elles rendent une classe de français vivante.", en: "After greetings, you will hear many short instructions: listen, repeat, look. They make a French class come alive." },
  t1_4_expl: { fr: "L'impératif sert à donner une instruction courte. Il y a trois formes utiles : écoute pour une personne que vous tutoyez, écoutez pour une personne en vous ou plusieurs personnes, et écoutons pour dire “let's listen”. Pour les verbes en -er, la forme avec tu perd souvent le s : tu écoutes → écoute ! Pour dire non, placez ne avant et pas après : Ne t'inquiète pas.", en: "The imperative is used to give a short instruction. There are three useful forms: écoute for one person you use tu with, écoutez for vous or several people, and écoutons for “let's listen”. For -er verbs, the tu form usually drops the s: tu écoutes → écoute! To make it negative, put ne before and pas after: Ne t'inquiète pas." },
  t1_4_ex1: { fr: "Écoute ! Écoutez ! Écoutons !", en: "Écoute! Écoutez! Écoutons! — Listen! / Listen! / Let's listen!" },
  ...
  t1_4_exercise: { fr: "Transformez en instruction familière : 1) Tu regardes le tableau. 2) Tu répètes la phrase. 3) Tu écoutes le dialogue. Puis dites les trois phrases à voix haute.", en: "Transform into a familiar instruction: 1) Tu regardes le tableau. 2) Tu répètes la phrase. 3) Tu écoutes le dialogue. Then say the three sentences aloud." },
  t1_4_tryit: { fr: "Situation pratique : vous aidez un nouvel apprenant en classe de français. Donnez-lui trois instructions simples. Par exemple : Écoute. Répète. Regarde le tableau. Dites-les, ne les écrivez pas seulement.", en: "Practical situation: you are helping a new learner in French class. Give them three simple instructions. For example: Écoute. Répète. Regarde le tableau. Say them; do not only write them." },

  // 1.5 — Yes, No, and Everything In Between
  t1_5_obj: { fr: "À la fin de cette leçon, vous pouvez répondre à des questions simples avec oui, non et si correctement.", en: "By the end of this lesson, you can answer simple questions using oui, non, and si correctly." },
  t1_5_hook: { fr: "Vous avez des sons, des salutations et des instructions. Dernière étape de ce track : répondre simplement, même quand la question est négative.", en: "You have sounds, greetings, and instructions. The final step in this track: answer simply, even when the question is negative." },
  t1_5_expl: { fr: "Pour poser une question simple à l'oral, vous pouvez garder la phrase et monter la voix à la fin : Tu parles français ? Pour dire non, mettez ne avant le verbe et pas après : Je ne parle pas français. Répondez oui à une question positive : Tu parles français ? Oui. Mais si la question est négative et que vous voulez dire “yes, actually”, utilisez si : Tu ne parles pas français ? Si, je parle français !", en: "To ask a simple spoken question, you can keep the sentence and raise your voice at the end: Tu parles français? To say no, put ne before the verb and pas after it: Je ne parle pas français. Answer oui to a positive question: Tu parles français? Oui. But if the question is negative and you mean “yes, actually”, use si: Tu ne parles pas français? Si, je parle français!" },
  t1_5_ex1: { fr: "Tu parles français ? Oui, je parle français. Non, je ne parle pas français.", en: "Tu parles français? Oui, je parle français. Non, je ne parle pas français. — Do you speak French? Yes / No." },
  t1_5_ex2: { fr: "Tu ne parles pas français ? Si, je parle français !", en: "Tu ne parles pas français? Si, je parle français! — Don't you speak French? Yes, I do!" },
  t1_5_ex3: { fr: "Tu viens ce soir ?", en: "Tu viens ce soir? — Are you coming tonight?" },
  t1_5_ex4: { fr: "Je ne comprends pas.", en: "Je ne comprends pas. — I don't understand." },
  t1_5_ex5: { fr: "Ce n'est pas grave.", en: "Ce n'est pas grave. — It's not a problem." },
  t1_5_ex6: { fr: "Il n'y a pas de problème.", en: "Il n'y a pas de problème. — There is no problem." },
  t1_5_exercise: { fr: "Répondez avec oui, non ou si : 1) Tu parles français ? 2) Tu ne parles pas français ? 3) Tu viens en classe ? 4) Tu n'as pas de stylo ? Dites la réponse complète quand vous pouvez.", en: "Answer with oui, non, or si: 1) Tu parles français? 2) Tu ne parles pas français? 3) Tu viens en classe? 4) Tu n'as pas de stylo? Say the full answer when you can." },
  t1_5_tryit: { fr: "Défi final : une personne vous pose quatre questions rapides. Répondez naturellement : deux réponses avec oui/non et une réponse avec si. Puis inversez les rôles si vous avez un partenaire.", en: "Final challenge: someone asks you four quick questions. Answer naturally: two answers with oui/non and one answer with si. Then switch roles if you have a partner." },

  // ================= TRACK 2 =================
  t2_hero_eyebrow: { fr: "Track 2 · 8 leçons", en: "Track 2 · 8 lessons" },
  t2_hero_title: { fr: "Core Grammar", en: "Core Grammar" },
  t2_hero_desc: { fr: "Construire le « moteur » de la phrase : articles, verbes, nombres, temps et comparaisons pour parler de la vraie vie.", en: "Build the sentence engine: articles, verbs, numbers, time, and comparisons for real-life French." },

  t2_1_title: { fr: "Nommer les choses : noms et articles", en: "Naming Things: Nouns and Articles" },
  t2_1_obj: { fr: "nommer des objets réels avec le bon article : le, la, l', les, un, une, des.", en: "name real objects with the right article: le, la, l', les, un, une, des." },
  t2_1_hook: { fr: "Après les premiers sons et échanges, vous avez besoin d'un réflexe simple : en français, chaque nom arrive presque toujours avec un petit mot devant lui.", en: "After your first sounds and exchanges, you need one simple reflex: in French, each noun almost always comes with a little word in front of it." },
  t2_1_expl: { fr: "Un nom français est masculin ou féminin. Apprenez le nom avec son article, comme un seul bloc : le stylo, la table. Utilisez le, la, l' ou les quand la chose est précise ; utilisez un, une ou des quand vous présentez quelque chose pour la première fois. Devant une voyelle ou un h muet, le et la deviennent l' : l'ami, l'hôtel. Au pluriel, le ou la devient les, et un ou une devient des.", en: "A French noun is masculine or feminine. Learn the noun with its article as one chunk: le stylo, la table. Use le, la, l', or les when the thing is specific; use un, une, or des when you introduce something for the first time. Before a vowel or silent h, le and la become l': l'ami, l'hôtel. In the plural, le or la becomes les, and un or une becomes des." },
  t2_1_ex1: { fr: "le stylo / un stylo", en: "le stylo / un stylo — the/a pen" },
  t2_1_ex2: { fr: "la fenêtre / une fenêtre", en: "la fenêtre / une fenêtre — the/a window" },
  t2_1_ex3: { fr: "Un livre est sur la table.", en: "Un livre est sur la table. — A book is on the table." },
  t2_1_ex4: { fr: "l'ami / l'hôtel", en: "l'ami / l'hôtel — the friend / the hotel" },
  t2_1_ex5: { fr: "les livres / des tables", en: "les livres / des tables — the books / some tables" },
  t2_1_exercise: { fr: "Reconnaître puis compléter : choisissez le bon article pour chaque objet — ___ téléphone, ___ table, ___ livre, ___ fenêtre, ___ étudiant. Ensuite, mettez deux mots au pluriel avec les ou des.", en: "Recognise, then complete: choose the right article for each object — ___ téléphone, ___ table, ___ livre, ___ fenêtre, ___ étudiant. Then put two words in the plural with les or des." },
  t2_1_tryit: { fr: "Regardez autour de vous. Choisissez cinq objets réels et dites-les à voix haute avec un article : le stylo, la fenêtre, un livre. Si vous êtes en classe, montrez l'objet pendant que vous le dites.", en: "Look around you. Choose five real objects and say them aloud with an article: le stylo, la fenêtre, un livre. If you are in class, point to the object as you say it." },

  t2_2_title: { fr: "« Je suis », « J'ai »", en: "“Je suis,” “J'ai”" },
  t2_2_obj: { fr: "vous présenter avec être et avoir : identité, âge, sensations et possessions.", en: "introduce yourself with être and avoir: identity, age, feelings, and possessions." },
  t2_2_hook: { fr: "Vous savez déjà nommer des choses. Maintenant, utilisez deux verbes essentiels pour parler de vous et des personnes autour de vous.", en: "You can already name things. Now use two essential verbs to talk about yourself and the people around you." },
  t2_2_expl: { fr: "Être veut dire to be : il sert à dire qui vous êtes, comment vous êtes, ou où vous êtes. Avoir veut dire to have, mais en français il sert aussi pour l'âge et certaines sensations : j'ai vingt ans, j'ai faim. Pour dire non, placez ne avant le verbe et pas après : je ne suis pas, je n'ai pas.", en: "Être means to be: it says who you are, how you are, or where you are. Avoir means to have, but French also uses it for age and some feelings: j'ai vingt ans, j'ai faim. To say no, put ne before the verb and pas after it: je ne suis pas, je n'ai pas." },
  t2_2_ex1: { fr: "Je suis étudiant.", en: "Je suis étudiant. — I am a student." },
  t2_2_ex2: { fr: "J'ai vingt ans.", en: "J'ai vingt ans. — I am twenty years old." },
  t2_2_ex3: { fr: "Je suis fatigué.", en: "Je suis fatigué. — I am tired." },
  t2_2_ex4: { fr: "J'ai un téléphone.", en: "J'ai un téléphone. — I have a phone." },
  t2_2_ex5: { fr: "Je ne suis pas professeur. Je n'ai pas de voiture.", en: "Je ne suis pas professeur. Je n'ai pas de voiture. — I am not a teacher. I don't have a car." },
  t2_2_exercise: { fr: "Complétez avec la bonne forme de être ou avoir : (1) Je ___ étudiant. (2) Tu ___ vingt ans ? (3) Nous ___ en classe. (4) Elle ___ un sac. Puis lisez les phrases à voix haute.", en: "Complete with the right form of être or avoir: (1) Je ___ étudiant. (2) Tu ___ vingt ans? (3) Nous ___ en classe. (4) Elle ___ un sac. Then read the sentences aloud." },
  t2_2_tryit: { fr: "Présentez-vous en quatre phrases : nom ou rôle, âge, une sensation aujourd'hui, et une chose que vous avez. Exemple : Je suis étudiant. J'ai vingt ans. Je suis content. J'ai un cahier.", en: "Introduce yourself in four sentences: name or role, age, one feeling today, and one thing you have. Example: Je suis étudiant. J'ai vingt ans. Je suis content. J'ai un cahier." },

  t2_3_title: { fr: "Parler du présent : les bases", en: "Talking About Now: The Basics" },
  t2_3_obj: { fr: "dire ce que vous faites maintenant ou régulièrement avec les verbes réguliers en -er.", en: "say what you do now or regularly with regular -er verbs." },
  t2_3_hook: { fr: "Vous pouvez déjà dire qui vous êtes. Ajoutons maintenant les actions simples de la vie quotidienne : parler, étudier, travailler, aimer.", en: "You can already say who you are. Now add simple daily actions: parler, étudier, travailler, aimer." },
  t2_3_expl: { fr: "Pour un verbe régulier en -er, retirez -er et ajoutez la terminaison qui correspond au sujet : je parle, tu parles, il parle, nous parlons, vous parlez, ils parlent. Beaucoup de terminaisons ne s'entendent pas à l'oral : écoutez surtout le sujet et le contexte.", en: "For a regular -er verb, remove -er and add the ending that matches the subject: je parle, tu parles, il parle, nous parlons, vous parlez, ils parlent. Many endings are not heard in speech, so listen especially for the subject and context." },
  t2_3_ex1: { fr: "parler → je parle, tu parles, il/elle parle, nous parlons, vous parlez, ils/elles parlent", en: "parler → je parle, tu parles, il/elle parle, nous parlons, vous parlez, ils/elles parlent" },
  t2_3_ex2: { fr: "Je parle français.", en: "Je parle français. — I speak French." },
  t2_3_ex3: { fr: "J'étudie à l'université.", en: "J'étudie à l'université. — I study at university." },
  t2_3_ex4: { fr: "Je travaille le lundi.", en: "Je travaille le lundi. — I work on Mondays." },
  t2_3_ex5: { fr: "J'aime le sport.", en: "J'aime le sport. — I like sport." },
  t2_3_exercise: { fr: "Complétez les formes de manger : je ___, tu ___, nous ___, vous ___. Ensuite, dites trois phrases vraies avec aimer, étudier ou travailler.", en: "Complete the forms of manger: je ___, tu ___, nous ___, vous ___. Then say three true sentences with aimer, étudier, or travailler." },
  t2_3_tryit: { fr: "Décrivez votre semaine en trois phrases simples. Utilisez au moins un jour : Je travaille lundi. J'étudie mardi. Je joue samedi.", en: "Describe your week in three simple sentences. Use at least one day: Je travaille lundi. J'étudie mardi. Je joue samedi." },
  t2_4_title: { fr: "Nombres, dates et heure", en: "Numbers, Dates, and Time" },
  t2_4_obj: { fr: "utiliser les nombres pour dire l'âge, un prix, une date, un jour et une heure.", en: "use numbers to say your age, a price, a date, a day, and a time." },
  t2_4_hook: { fr: "Vous connaissez déjà quelques phrases. Les nombres les rendent utiles dans la vraie vie : âge, cours, transport, rendez-vous, anniversaires et achats.", en: "You already know a few sentences. Numbers make them useful in real life: age, classes, transport, appointments, birthdays, and shopping." },
  t2_4_numbers_title: { fr: "Les nombres", en: "Numbers" },
  t2_4_numbers_expl: { fr: "Commencez petit : maîtrisez 0–20, puis les dizaines utiles. Pour 21, 31, 41, 51 et 61, on ajoute et un : vingt et un. Pour 70, pensez soixante-dix ; pour 80, quatre-vingts ; pour 90, quatre-vingt-dix.", en: "Start small: master 0–20, then the useful tens. For 21, 31, 41, 51, and 61, add et un: vingt et un. For 70, think soixante-dix; for 80, quatre-vingts; for 90, quatre-vingt-dix." },
  t2_4_ex1: { fr: "0–10 : zéro, un, deux, trois, quatre, cinq, six, sept, huit, neuf, dix", en: "0–10 : zéro, un, deux, trois, quatre, cinq, six, sept, huit, neuf, dix" },
  t2_4_ex2: { fr: "11–20 : onze, douze, treize, quatorze, quinze, seize, dix-sept, dix-huit, dix-neuf, vingt", en: "11–20 : onze, douze, treize, quatorze, quinze, seize, dix-sept, dix-huit, dix-neuf, vingt" },
  t2_4_ex3: { fr: "30–100 : trente, quarante, cinquante, soixante, soixante-dix, quatre-vingts, quatre-vingt-dix, cent", en: "30–100 : trente, quarante, cinquante, soixante, soixante-dix, quatre-vingts, quatre-vingt-dix, cent" },
  t2_4_ex4: { fr: "J'ai vingt ans. Il y a trois étudiants. Ça coûte vingt mille francs.", en: "J'ai vingt ans. Il y a trois étudiants. Ça coûte vingt mille francs." },
  t2_4_ord_title: { fr: "Les nombres ordinaux", en: "Ordinal numbers" },
  t2_4_ord_expl: { fr: "Un nombre cardinal donne une quantité : trois livres. Un nombre ordinal donne une position : le troisième livre.", en: "A cardinal number gives a quantity: trois livres. An ordinal number gives a position: le troisième livre." },
  t2_4_ex5: { fr: "premier / première, deuxième, troisième, quatrième, cinquième", en: "premier / première, deuxième, troisième, quatrième, cinquième" },
  t2_4_ex6: { fr: "C'est mon troisième livre.", en: "C'est mon troisième livre." },
  t2_4_days_title: { fr: "Les jours de la semaine", en: "Days of the week" },
  t2_4_ex7: { fr: "lundi, mardi, mercredi, jeudi, vendredi, samedi, dimanche", en: "lundi, mardi, mercredi, jeudi, vendredi, samedi, dimanche" },
  t2_4_ex8: { fr: "Nous avons cours mardi. Je joue au hockey samedi.", en: "Nous avons cours mardi. Je joue au hockey samedi." },
  t2_4_months_title: { fr: "Les mois", en: "Months" },
  t2_4_months_expl: { fr: "Avec un mois, utilisez souvent en : en juin, en août, en septembre.", en: "With a month, often use en: en juin, en août, en septembre." },
  t2_4_ex9: { fr: "janvier, février, mars, avril, mai, juin", en: "janvier, février, mars, avril, mai, juin" },
  t2_4_ex10: { fr: "juillet, août, septembre, octobre, novembre, décembre", en: "juillet, août, septembre, octobre, novembre, décembre" },
  t2_4_ex11: { fr: "Je suis né en juin. Les cours commencent en septembre.", en: "Je suis né en juin. Les cours commencent en septembre." },
  t2_4_seasons_title: { fr: "Les saisons", en: "Seasons" },
  t2_4_ex12: { fr: "le printemps, l'été, l'automne, l'hiver", en: "le printemps, l'été, l'automne, l'hiver" },
  t2_4_ex13: { fr: "J'aime l'été. En hiver, il fait froid. Au printemps, il fait beau.", en: "J'aime l'été. En hiver, il fait froid. Au printemps, il fait beau." },
  t2_4_dates_title: { fr: "Dire la date", en: "Saying the date" },
  t2_4_dates_expl: { fr: "La structure naturelle est le + nombre + mois : le 5 mai. Pour le premier jour du mois, dites le premier mai.", en: "The natural structure is le + number + month: le 5 mai. For the first day of a month, say le premier mai." },
  t2_4_ex14: { fr: "Nous sommes le 25 juillet.", en: "Nous sommes le 25 juillet." },
  t2_4_ex15: { fr: "Mon anniversaire est le 10 juin. Le cours est le 3 septembre.", en: "Mon anniversaire est le 10 juin. Le cours est le 3 septembre." },
  t2_4_ex16: { fr: "le premier mai", en: "le premier mai" },
  t2_4_time_title: { fr: "Dire l'heure", en: "Telling time" },
  t2_4_time_expl: { fr: "Demandez : Quelle heure est-il ? Répondez avec Il est une heure, deux heures, trois heures. Dans les horaires, 9h00 se lit neuf heures ; 14h30 peut se dire quatorze heures trente.", en: "Ask: Quelle heure est-il? Answer with Il est une heure, deux heures, trois heures. In schedules, 9h00 is read neuf heures; 14h30 can be quatorze heures trente." },
  t2_4_ex17: { fr: "Quelle heure est-il ? Il est une heure. Il est deux heures.", en: "Quelle heure est-il ? Il est une heure. Il est deux heures." },
  t2_4_ex18: { fr: "Il est trois heures et demie. Il est quatre heures et quart. Il est cinq heures moins le quart.", en: "Il est trois heures et demie. Il est quatre heures et quart. Il est cinq heures moins le quart." },
  t2_4_ex19: { fr: "Le cours commence à neuf heures. Nous nous retrouvons à dix-huit heures.", en: "Le cours commence à neuf heures. Nous nous retrouvons à dix-huit heures." },
  t2_4_expr_title: { fr: "Expressions de temps", en: "Time expressions" },
  t2_4_ex20: { fr: "aujourd'hui, demain, hier, ce matin, cet après-midi, ce soir, cette semaine, la semaine prochaine", en: "aujourd'hui, demain, hier, ce matin, cet après-midi, ce soir, cette semaine, la semaine prochaine" },
  t2_4_ex21: { fr: "Je vais étudier demain. Nous avons cours ce matin. Je vais sortir ce soir.", en: "Je vais étudier demain. Nous avons cours ce matin. Je vais sortir ce soir." },
  t2_4_exercise: { fr: "Écrivez ces informations en français : 9h00, 14h30, 18h15 ; le 5 mai, le 12 juin, le 25 juillet. Puis dites votre mois de naissance avec en.", en: "Écrivez ces informations en français : 9h00, 14h30, 18h15 ; le 5 mai, le 12 juin, le 25 juillet. Puis dites votre mois de naissance avec en." },
  t2_4_tryit: { fr: "Situation réelle : organisez un rendez-vous. Dites le jour, la date et l'heure : Nous avons cours mardi, le 3 septembre, à neuf heures. Ensuite, donnez une phrase sur demain ou ce soir.", en: "Situation réelle : organisez un rendez-vous. Dites le jour, la date et l'heure : Nous avons cours mardi, le 3 septembre, à neuf heures. Ensuite, donnez une phrase sur demain ou ce soir." },
  t2_5_title: { fr: "Plus de verbes d'action", en: "More Action Verbs" },
  t2_5_obj: { fr: "parler d'actions utiles avec les verbes réguliers en -ir et en -re.", en: "talk about useful actions with regular -ir and -re verbs." },
  t2_5_hook: { fr: "Vous utilisez déjà les verbes en -er. Voici deux nouvelles familles pour dire finir, choisir, vendre, attendre et entendre.", en: "You already use -er verbs. Here are two new families for saying finir, choisir, vendre, attendre, and entendre." },
  t2_5_expl: { fr: "Les verbes réguliers en -ir comme finir ajoutent -is, -is, -it, -issons, -issez, -issent. Les verbes réguliers en -re comme vendre ajoutent -s, -s, rien, -ons, -ez, -ent. Apprenez le modèle, puis utilisez-le tout de suite dans une phrase réelle.", en: "Regular -ir verbs like finir add -is, -is, -it, -issons, -issez, -issent. Regular -re verbs like vendre add -s, -s, nothing, -ons, -ez, -ent. Learn the model, then use it right away in a real sentence." },
  ...
  t2_5_ex2: { fr: "Je choisis un livre pour le cours.", en: "Je choisis un livre pour le cours." },
  ...
  t2_5_ex4: { fr: "J'attends le bus à Kampala.", en: "J'attends le bus à Kampala." },
  t2_5_ex5: { fr: "Tu entends la question ?", en: "Tu entends la question ?" },
  t2_5_exercise: { fr: "Complétez les formes de réussir et vendre pour je, nous et ils. Ensuite, utilisez une forme dans une phrase sur quelque chose que vous voulez réussir ou vendre.", en: "Complétez les formes de réussir et vendre pour je, nous et ils. Ensuite, utilisez une forme dans une phrase sur quelque chose que vous voulez réussir ou vendre." },
  t2_5_tryit: { fr: "Créez trois phrases vraies : une avec finir, une avec choisir, une avec attendre ou entendre. Lisez-les à voix haute comme de vraies informations, pas comme une liste.", en: "Créez trois phrases vraies : une avec finir, une avec choisir, une avec attendre ou entendre. Lisez-les à voix haute comme de vraies informations, pas comme une liste." },
  t2_6_title: { fr: "Parler du futur proche", en: "Talking About the Near Future" },
  t2_6_obj: { fr: "dire ce que vous allez faire bientôt avec aller + infinitif.", en: "say what you are going to do soon with aller + infinitive." },
  t2_6_hook: { fr: "Vous connaissez des verbes d'action. Avec aller, vous pouvez maintenant transformer ces actions en projets.", en: "You know action verbs. With aller, you can now turn those actions into plans." },
  t2_6_expl: { fr: "Le futur proche se forme avec aller au présent + un verbe à l'infinitif : je vais étudier. Gardez le deuxième verbe à l'infinitif ; ne le conjuguez pas. C'est très courant à l'oral pour parler de ce soir, demain, ce week-end ou la semaine prochaine.", en: "The near future is formed with present-tense aller + an infinitive: je vais étudier. Keep the second verb in the infinitive; do not conjugate it. This is very common in speech for tonight, tomorrow, this weekend, or next week." },
  t2_6_ex1: { fr: "Je vais étudier.", en: "Je vais étudier." },
  t2_6_ex2: { fr: "Tu vas voyager.", en: "Tu vas voyager." },
  t2_6_ex3: { fr: "Nous allons manger.", en: "Nous allons manger." },
  t2_6_ex4: { fr: "Ils vont arriver demain.", en: "Ils vont arriver demain." },
  t2_6_ex5: { fr: "Je vais aller à Kampala ce week-end.", en: "Je vais aller à Kampala ce week-end." },
  t2_6_exercise: { fr: "Transformez en futur proche : (1) Je mange. (2) Tu voyages. (3) Elle travaille. (4) Nous finissons. Puis ajoutez un moment : ce soir, demain ou ce week-end.", en: "Transformez en futur proche : (1) Je mange. (2) Tu voyages. (3) Elle travaille. (4) Nous finissons. Puis ajoutez un moment : ce soir, demain ou ce week-end." },
  t2_6_tryit: { fr: "Dites à quelqu'un trois choses que vous allez faire ce week-end. Si vous êtes seul(e), enregistrez-vous ou lisez-les à voix haute : Je vais..., Je vais..., Je vais...", en: "Dites à quelqu'un trois choses que vous allez faire ce week-end. Si vous êtes seul(e), enregistrez-vous ou lisez-les à voix haute : Je vais..., Je vais..., Je vais..." },
  t2_7_title: { fr: "Qu'est-ce que tu fais ? (faire & prépositions)", en: "What Are You Doing? (faire & prepositions)" },
  t2_7_obj: { fr: "décrire des activités, des lieux et des déplacements avec faire, à, en, au et de.", en: "describe activities, places, and movement with faire, à, en, au, and de." },
  t2_7_hook: { fr: "Vous pouvez parler de vos projets. Maintenant, précisez l'activité et le lieu : sport, devoirs, pays, ville, origine.", en: "You can talk about your plans. Now be more precise about the activity and the place: sport, homework, country, city, origin." },
  t2_7_expl: { fr: "Faire sert à beaucoup d'activités : faire du sport, faire mes devoirs, faire la cuisine. Pour les lieux, pensez situation : à indique souvent une ville ou un lieu précis ; en s'utilise avec beaucoup de pays féminins ou commençant par une voyelle ; au s'utilise avec un pays masculin comme le Canada ; de indique souvent l'origine.", en: "Faire is used for many activities: faire du sport, faire mes devoirs, faire la cuisine. For places, think about the situation: à often marks a city or specific place; en is used with many feminine countries or countries starting with a vowel; au is used with a masculine country like le Canada; de often marks origin." },
  t2_7_ex1: { fr: "Je fais du sport.", en: "Je fais du sport." },
  t2_7_ex2: { fr: "Je fais mes devoirs ce soir.", en: "Je fais mes devoirs ce soir." },
  t2_7_ex3: { fr: "Je vais à Kampala.", en: "Je vais à Kampala." },
  t2_7_ex4: { fr: "Je vis en Ouganda. Je voyage en France.", en: "Je vis en Ouganda. Je voyage en France." },
  t2_7_ex5: { fr: "Je vais au Canada. Je viens de Kampala.", en: "Je vais au Canada. Je viens de Kampala." },
  t2_7_exercise: { fr: "Complétez : (1) Je ___ du sport. (2) Nous allons ___ Kampala. (3) Elle vit ___ Ouganda. (4) Il va ___ Canada. Puis dites une phrase vraie avec faire et une phrase vraie avec un lieu.", en: "Complétez : (1) Je ___ du sport. (2) Nous allons ___ Kampala. (3) Elle vit ___ Ouganda. (4) Il va ___ Canada. Puis dites une phrase vraie avec faire et une phrase vraie avec un lieu." },
  t2_7_tryit: { fr: "Répondez à la question : Qu'est-ce que tu fais cette semaine ? Donnez trois activités et un lieu. Exemple : Je fais du sport lundi. Je vais à l'université. Je vis en Ouganda.", en: "Répondez à la question : Qu'est-ce que tu fais cette semaine ? Donnez trois activités et un lieu. Exemple : Je fais du sport lundi. Je vais à l'université. Je vis en Ouganda." },
  t2_8_title: { fr: "Comparer les choses", en: "Comparing Things" },
  t2_8_obj: { fr: "comparer des personnes, des lieux et des objets, puis dire à qui ils appartiennent.", en: "compare people, places, and objects, then say who they belong to." },
  t2_8_hook: { fr: "Vous savez décrire avec être. Maintenant, rendez vos descriptions plus précises : plus grand, moins cher, le plus utile, mon livre.", en: "You know how to describe with être. Now make your descriptions more precise: plus grand, moins cher, le plus utile, mon livre." },
  t2_8_expl: { fr: "Pour comparer deux choses, placez plus, moins ou aussi avant l'adjectif, puis que : plus grand que. Pour dire the most ou the least, utilisez le plus, la plus, les plus ou le moins, la moins, les moins. Les possessifs comme mon, ma et mes s'accordent avec l'objet possédé : mon livre, ma maison, mes amis.", en: "To compare two things, put plus, moins, or aussi before the adjective, then que: plus grand que. To say the most or the least, use le plus, la plus, les plus or le moins, la moins, les moins. Possessives like mon, ma, and mes agree with the thing owned: mon livre, ma maison, mes amis." },
  t2_8_ex1: { fr: "Kampala est plus grande que Jinja.", en: "Kampala est plus grande que Jinja." },
  t2_8_ex2: { fr: "Ce livre est moins cher que celui-là.", en: "Ce livre est moins cher que celui-là." },
  t2_8_ex3: { fr: "Ce téléphone est le plus utile.", en: "Ce téléphone est le plus utile." },
  t2_8_ex4: { fr: "C'est mon livre. C'est ma maison. Ce sont mes amis.", en: "C'est mon livre. C'est ma maison. Ce sont mes amis." },
  t2_8_ex5: { fr: "Mon sac est plus petit que ta valise.", en: "Mon sac est plus petit que ta valise." },
  t2_8_exercise: { fr: "Complétez avec plus, moins, le plus, mon, ma ou mes : (1) Kampala est ___ grande que Jinja. (2) Ce livre est ___ cher. (3) C'est ___ maison. Ensuite, comparez deux objets sur votre table.", en: "Complétez avec plus, moins, le plus, mon, ma ou mes : (1) Kampala est ___ grande que Jinja. (2) Ce livre est ___ cher. (3) C'est ___ maison. Ensuite, comparez deux objets sur votre table." },
  t2_8_tryit: { fr: "Choisissez deux lieux, deux objets ou deux personnes que vous connaissez. Dites trois comparaisons réelles et une phrase de possession. Exemple : Mon téléphone est plus petit que mon ordinateur.", en: "Choisissez deux lieux, deux objets ou deux personnes que vous connaissez. Dites trois comparaisons réelles et une phrase de possession. Exemple : Mon téléphone est plus petit que mon ordinateur." }
};
...
function initListenButtons() {
  ...
  document.querySelectorAll(".lesson-examples li").forEach((li) => {
    ...
    // Prefer explicit French-only audio text. This keeps translations,
    // notes, labels, and pronunciation guides out of the speech engine,
    // even when the interface is switched to English.
    const frenchPart = (li.dataset.audio || "").trim();
    ...
    stories: [
      {
        ...
        fr: "Un dimanche matin, les rues peuvent sembler plus calmes que d'habitude, mais les maisons, elles, sont déjà en mouvement. On repasse une tenue, on appelle les enfants, on vérifie qu'on n'a pas oublié le sac. Dans beaucoup de familles, la journée commence par l'église ou la mosquée. Ce n'est pas seulement une question d'heure : c'est un rendez-vous avec sa communauté.\n\nOn s'habille pour marquer le jour. Une gomesi aux manches bouffantes peut illuminer une cour; un kanzu blanc se porte volontiers lors des grandes occasions. Après le service, les salutations s'étirent. Il faut demander des nouvelles, reconnaître les visages, échanger quelques mots avant de rentrer. La journée ne se mesure pas à la vitesse à laquelle on la traverse.\n\nPuis vient le déjeuner, souvent le vrai centre de gravité du dimanche. Matooke, riz, poulet ou haricots arrivent sur la table, et il n'est pas rare qu'un voisin ou un proche se joigne au repas. Une visite imprévue n'est pas une intrusion à expliquer : c'est une occasion de tirer une chaise de plus.\n\nL'après-midi ralentit sans devenir silencieux. Dans la cour, les enfants jouent; dehors, les adultes discutent de la semaine, du football, de ce qui se prépare. Le dimanche ougandais rappelle qu'un jour de repos peut être très vivant : il laisse de la place aux gens, aux conversations et à un repas qu'on n'a aucune envie de finir trop vite.",
        en: "On a Sunday morning, the streets may look quieter than usual, but homes are already busy. Clothes are being pressed, children called, bags checked. In many families the day begins at church or at the mosque. It is not just an appointment on the calendar; it is a time to be with the community.\n\nPeople dress to mark the day. A gomesi with its full sleeves can brighten a courtyard; a white kanzu is often worn for important occasions. After the service, greetings take their time. People ask after one another, recognize familiar faces, and exchange a few words before heading home. The day is not measured by how quickly it is crossed.\n\nThen comes lunch, often the true centre of a Sunday. Matooke, rice, chicken, or beans reach the table, and a neighbour or relative may easily join the meal. An unannounced visit is not an interruption requiring an apology; it is a reason to pull up another chair.\n\nThe afternoon slows without falling silent. Children play in the yard while adults talk outside about the week, football, and coming plans. A Ugandan Sunday shows that a day of rest can be full of life: it makes room for people, conversation, and a meal nobody is in a hurry to end."
      },
      {
        title: { fr: "Les marchés de Kampala", en: "The Markets of Kampala" },
        fr: "À Kampala, aller au marché commence rarement par une liste parfaitement respectée. À peine entré à Owino, Nakasero ou Kalerwe, on est happé par les appels des vendeuses, les piles de tomates, le parfum des épices et le bruit des pas. Quelqu'un vous lance un surnom affectueux; quelqu'un d'autre promet le meilleur prix. Le marché vous répond avant même que vous ayez posé une question.\n\nChaque lieu a son caractère. Owino est célèbre pour ses vêtements de seconde main et ses allées où l'on peut dénicher une veste, des chaussures ou un tissu inattendu. À Nakasero, les fruits et légumes colorent les étals. Kalerwe est souvent associé aux prix serrés et à une circulation qui demande un peu de patience.\n\nMarchander y est une conversation, pas seulement une bataille de chiffres. On compare, on plaisante, on revient vers le même étal; parfois un morceau de fruit est tendu « pour goûter ». Cela ne signifie pas que tout est facile ou que tout le monde a du temps à perdre. C'est plutôt une manière très sociale de décider, de reconnaître un client et de faire vivre un petit commerce.\n\nEntre les sacs de charbon, les régimes de bananes et les paniers de légumes, on croise aussi des connaissances et l'on échange les nouvelles du quartier. On repart avec un sac plus lourd, peut-être avec une bonne affaire, mais surtout avec l'impression d'avoir traversé un morceau de la ville. À Kampala, le marché nourrit les cuisines; il nourrit aussi les liens.",
        en: "In Kampala, a market trip rarely begins and ends with a perfectly followed list. The moment you enter Owino, Nakasero, or Kalerwe, vendors' calls, stacks of tomatoes, the scent of spices, and the sound of feet pull you in. Someone offers an affectionate nickname; someone else promises the best price. The market answers before you have asked a question.\n\nEach place has its own character. Owino is known for second-hand clothes and lanes where a jacket, shoes, or an unexpected piece of fabric may turn up. At Nakasero, fruit and vegetables bring colour to the stalls. Kalerwe is often associated with keen prices and a bustle that asks for patience.\n\nHaggling is a conversation, not merely a contest of numbers. People compare, joke, return to the same stall; sometimes a piece of fruit is offered \"to taste.\" That does not mean everything is easy or that everyone has time to spare. It is a social way to decide, to recognize a customer, and to keep a small business alive.\n\nAmong sacks of charcoal, banana bunches, and baskets of vegetables, people also meet acquaintances and exchange neighbourhood news. You leave with a heavier bag, perhaps with a bargain, but above all with the feeling of having crossed a piece of the city. In Kampala, the market feeds kitchens; it also feeds relationships."
      },
      {
        title: { fr: "Le gomesi et le kanzu, l'élégance ougandaise", en: "Gomesi and Kanzu, Ugandan Elegance" },
        fr: "À un kwanjula ou à un mariage, on comprend vite que les vêtements participent à la fête. Avant même que la musique commence, les couleurs des gomesi remplissent la cour et les kanzu blancs donnent aux hommes une allure cérémonieuse. Ce ne sont pas de simples tenues « traditionnelles » sorties pour une photo : elles disent que le moment compte.\n\nLe gomesi, très associé à la culture baganda, se reconnaît à ses manches généreuses, à sa taille marquée et à sa longue jupe. Il peut être sobre ou éclatant, choisi avec des bijoux et un sash assorti. Le kanzu, longue tunique blanche portée par les hommes, accompagne quant à lui les cérémonies, les prières et les moments formels. Selon l'occasion, une veste peut le compléter.\n\nLes deux vêtements demandent du soin. On parle du tissu, de la coupe, de la manière de le porter; les préparatifs deviennent déjà une part de l'événement. Ils relient aussi les générations : une tante peut aider à ajuster une gomesi, un aîné rappeler ce qui convient à la cérémonie.\n\nAujourd'hui, Kampala est aussi une ville de jeans, de baskets et de mode contemporaine. C'est justement ce contraste qui donne au gomesi et au kanzu leur force. Les porter ne revient pas à tourner le dos au présent. C'est choisir, pour une journée importante, une élégance qui porte une mémoire familiale et culturelle.",
        en: "At a kwanjula or a wedding, it quickly becomes clear that clothes are part of the celebration. Before the music starts, brightly coloured gomesi fill the courtyard and white kanzu give the men a ceremonial presence. These are not simply \"traditional outfits\" brought out for a photograph: they say that the occasion matters.\n\nThe gomesi, closely associated with Baganda culture, is known for its generous sleeves, shaped waist, and long skirt. It may be understated or vivid, matched with jewellery and a sash. The kanzu, a long white tunic worn by men, belongs at ceremonies, prayers, and formal moments. A jacket may be added depending on the occasion.\n\nBoth garments invite care. People discuss the fabric, the cut, and how to wear them; getting ready becomes part of the event itself. They also connect generations: an aunt may help adjust a gomesi, while an elder may remind someone what suits the ceremony.\n\nKampala is also a city of jeans, trainers, and contemporary fashion. That contrast is exactly what gives the gomesi and kanzu their power. Wearing them is not a rejection of the present. On an important day, it is a choice of elegance that carries family and cultural memory."
      },
      {
        title: { fr: "Les boda-bodas, le pouls de la ville", en: "Boda-Bodas, the City's Pulse" },
        fr: "Quand la circulation se bloque à Kampala et que les voitures semblent ne plus avancer, on entend souvent le bourdonnement d'une moto avant de la voir. Les boda-bodas se glissent dans les rues, attendent aux carrefours et proposent une réponse immédiate à la grande question de la ville : comment arriver à l'heure ?\n\nLe nom viendrait de l'expression « border to border », héritée des motos qui transportaient des passagers près des frontières. Aujourd'hui, le boda-boda fait partie du paysage urbain et bien au-delà : il emmène au travail, au marché, à un rendez-vous ou au dernier bout du chemin quand le taxi collectif ne va plus jusqu'à la porte.\n\nUn trajet se négocie d'abord : destination, prix, parfois itinéraire. Pour les habitués, le conducteur connu devient une petite ressource du quotidien. Mais l'efficacité ne doit pas faire oublier la prudence. Casque, vitesse raisonnable et conducteur attentif comptent; la moto partage la route avec des piétons, des taxis et une circulation imprévisible.\n\nLe boda-boda n'est donc pas seulement une image animée de Kampala. Il révèle une ville qui cherche sans cesse des moyens de se déplacer, de travailler et de s'adapter. Dans son vrombissement, il y a l'urgence d'un rendez-vous, mais aussi l'ingéniosité ordinaire qui maintient la ville en mouvement.",
        en: "When Kampala traffic locks up and cars seem unable to move, the buzz of a motorcycle is often heard before it is seen. Boda-bodas weave through streets, wait at junctions, and offer an immediate answer to the city's big question: how do you get there on time?\n\nThe name is commonly linked to \"border to border,\" recalling motorcycles that carried passengers near the borders. Today the boda-boda is part of the urban landscape and far beyond it: it takes people to work, the market, an appointment, or along the final stretch when a shared taxi does not reach the door.\n\nA journey begins with a negotiation: destination, fare, and sometimes route. For regular passengers, a familiar rider can become a small but important part of everyday life. Yet efficiency should not hide the need for care. A helmet, sensible speed, and an attentive rider matter; motorcycles share the road with pedestrians, taxis, and unpredictable traffic.\n\nA boda-boda is not simply a lively image of Kampala. It reveals a city constantly finding ways to move, work, and adapt. Its engine carries the urgency of an appointment, but also the everyday ingenuity that keeps the city going."
      },
      {
        title: { fr: "Les clans, une famille élargie", en: "Clans, an Extended Family" },
        fr: "Dans une conversation de famille ou lors d'une cérémonie baganda, une question peut arriver très naturellement : « Tu es de quel clan ? » Pour quelqu'un qui découvre l'Ouganda, elle peut surprendre. Pourtant, elle ouvre souvent une discussion sur les liens, les aînés et la place de chacun dans une histoire plus vaste.\n\nChez les Baganda, le clan — ekika — relie des personnes par une lignée et par un totem, souvent un animal, une plante ou un élément naturel. Les noms de clans, comme Ngeye (le singe) ou Ffumbe (la civette), ne sont pas de simples étiquettes. Ils portent des récits, des règles de respect et une mémoire transmise au sein des familles.\n\nLe clan ne remplace pas la famille proche, et il ne résume pas à lui seul l'identité d'un Ougandais. L'Ouganda rassemble de nombreuses communautés, chacune avec ses propres façons de penser la parenté. Mais dans le Buganda, savoir son ekika peut aider à situer des relations, à honorer les aînés et à comprendre certaines règles sociales, notamment autour du mariage.\n\nDerrière cette question apparemment simple se trouve une idée forte : personne n'arrive seul dans une pièce. On arrive aussi avec des liens, des responsabilités et des histoires. C'est peut-être pour cela qu'elle est si souvent posée avec curiosité plutôt qu'avec formalité.",
        en: "In a family conversation or at a Baganda ceremony, a question may come quite naturally: \"Which clan are you from?\" To someone discovering Uganda, it can be surprising. Yet it often opens a conversation about ties, elders, and each person's place in a larger story.\n\nAmong the Baganda, a clan—ekika—connects people through lineage and a totem, often an animal, plant, or natural element. Clan names such as Ngeye (monkey) or Ffumbe (civet) are not mere labels. They carry stories, rules of respect, and a memory passed through families.\n\nA clan does not replace the immediate family, nor does it alone define a Ugandan's identity. Uganda brings together many communities, each with its own ways of understanding kinship. But in Buganda, knowing one's ekika can help place relationships, honour elders, and understand certain social rules, including those around marriage.\n\nBehind this seemingly simple question is a powerful idea: no one enters a room alone. People also arrive with ties, responsibilities, and stories. Perhaps that is why the question is so often asked with curiosity rather than ceremony."
      },
      {
        title: { fr: "Le football, une passion nationale", en: "Football, a National Passion" },
        fr: "Il suffit qu'un match important commence pour qu'une conversation change de rythme. Devant un écran dans un café, dans un salon ou près d'un petit kiosque, chacun a son avis sur la composition, l'arbitrage et le but qui aurait dû être marqué. Le football donne à beaucoup d'Ougandais une langue commune, même entre personnes qui viennent de se rencontrer.\n\nLa Premier League anglaise occupe une place énorme dans ces discussions, mais la passion ne s'arrête pas aux clubs européens. Les Cranes, l'équipe nationale masculine, et les compétitions locales suscitent leur propre ferveur. Dans les quartiers, des enfants transforment un espace libre en terrain et prolongent le match jusqu'à ce que la lumière baisse.\n\nCe qui compte n'est pas seulement le score. Le match permet de se retrouver, de taquiner un ami qui soutient l'autre équipe, de commenter une action avec des inconnus devenus alliés le temps d'une mi-temps. Une victoire offre de quoi parler pendant des jours; une défaite aussi, souvent avec autant de passion.\n\nLe football ne résout pas les différences du quotidien, mais il crée une scène où elles peuvent se mêler. Pendant quatre-vingt-dix minutes, la ville écoute, répond et débat. Puis le coup de sifflet final n'interrompt pas vraiment l'histoire : il la déplace dans la rue, le taxi et la conversation du lendemain.",
        en: "All it takes is the start of an important match for a conversation to change pace. In front of a screen at a café, in a sitting room, or beside a small kiosk, everyone has an opinion about the lineup, the referee, and the goal that should have been scored. Football gives many Ugandans a shared language, even when they have only just met.\n\nEngland's Premier League has a huge place in these conversations, but the passion does not end with European clubs. The Cranes, the men's national team, and local competitions inspire their own excitement. In neighbourhoods, children turn an open space into a pitch and keep playing until the light fades.\n\nThe score is not the only thing that matters. A match is a reason to gather, tease a friend who supports the other side, and analyse a move with strangers who become allies for one half. A win supplies conversation for days; a loss does too, often with just as much feeling.\n\nFootball does not erase everyday differences, but it creates a space where they can mingle. For ninety minutes the city listens, answers, and argues. The final whistle does not really end the story: it carries it into the street, the taxi, and the next day's conversation."
      },
      {
        title: { fr: "Le rire ougandais, l'essor du stand-up", en: "Ugandan Laughter and the Rise of Stand-Up" },
        fr: "Dans une salle de Kampala, le rire peut commencer avant même que le comédien ait fini sa phrase. Une remarque sur les embouteillages, un parent trop direct ou une promesse de boda-boda suffit parfois : le public reconnaît immédiatement une situation qu'il connaît trop bien. C'est là que le stand-up trouve sa force, dans ce petit éclair de reconnaissance partagé.\n\nLa scène ougandaise de la comédie a grandi grâce aux spectacles, aux émissions et aux vidéos qui circulent en ligne. Les humoristes puisent dans la vie quotidienne : le travail, les relations, les langues qui se croisent, les habitudes de quartier ou les petites contradictions de la ville. Ils ne racontent pas une Ouganda abstraite; ils mettent un projecteur sur les détails que le public voit chaque jour.\n\nL'humour peut être tendre, absurde, mordant ou très physique. Il demande aussi au public de connaître le contexte : pourquoi telle expression luganda fait rire, pourquoi une scène de famille est familière, pourquoi un trajet ordinaire devient une aventure. Une bonne blague révèle souvent autant qu'elle amuse.\n\nRire ensemble ne rend pas les difficultés moins réelles. Mais cela permet de les regarder de côté, avec un peu d'air et beaucoup de complicité. Quand une salle éclate de rire devant une vérité très locale, elle dit aussi : « nous reconnaissons cette vie, et nous la partageons ».",
        en: "In a Kampala room, laughter can start before the comedian has even finished the sentence. A remark about traffic, a parent who is too direct, or a boda-boda promise may be enough: the audience immediately recognizes a situation it knows all too well. That small shared flash of recognition is where stand-up finds its power.\n\nUganda's comedy scene has grown through live shows, programmes, and videos shared online. Comedians draw on everyday life: work, relationships, languages crossing paths, neighbourhood habits, and the small contradictions of the city. They do not describe an abstract Uganda; they put a spotlight on details the audience sees every day.\n\nThe humour may be affectionate, absurd, sharp, or highly physical. It also asks the audience to know the context: why a Luganda expression is funny, why a family scene feels familiar, or why an ordinary journey becomes an adventure. A good joke often reveals as much as it entertains.\n\nLaughing together does not make difficulties less real. But it can make space to look at them from the side, with a little breathing room and plenty of complicity. When a room bursts into laughter at a very local truth, it is also saying: \"We recognize this life, and we share it.\""
      },
      {
        title: { fr: "Le Luga-Flow, la fierté de la langue", en: "Luga-Flow, Pride in Language" },
        fr: "On peut entendre une chanson à Kampala sans saisir chaque mot et sentir tout de même qu'elle appartient à la ville. Le rythme, les ad-libs, une phrase en luganda reprise par le public : la langue devient une partie du son. C'est l'une des forces du Luga-Flow, ce rap et cette écriture urbaine qui placent le luganda au centre de la musique contemporaine.\n\nLe luganda est largement parlé dans le centre de l'Ouganda et sert souvent de langue de communication à Kampala, aux côtés de l'anglais et de nombreuses autres langues ougandaises. Dans la musique, son usage ne relève pas seulement de la traduction. Ses images, ses jeux de mots et sa musicalité permettent de raconter la ville avec ses propres références.\n\nLe Luga-Flow a donné une visibilité particulière à des artistes qui choisissent de rapper, chanter ou mélanger les langues sans demander la permission de sonner ailleurs. Les paroles peuvent parler d'ambition, d'amour, de quartier, de politique quotidienne ou d'humour. Elles peuvent aussi circuler très loin, même lorsque certains auditeurs cherchent encore le sens d'un mot.\n\nCette musique rappelle qu'une langue ne vit pas seulement dans les livres ou les cours. Elle vit quand on la transforme, quand on la fait rimer, quand une foule la crie en même temps. Entendre du luganda dans un morceau, c'est entendre une ville qui parle avec son propre rythme.",
        en: "You can hear a song in Kampala without catching every word and still feel that it belongs to the city. The beat, the ad-libs, a Luganda phrase repeated by the crowd: language becomes part of the sound. That is one of the strengths of Luga-Flow, the urban rap and writing that place Luganda at the centre of contemporary music.\n\nLuganda is widely spoken in central Uganda and often serves as a language of communication in Kampala, alongside English and many other Ugandan languages. In music, using it is not merely a matter of translation. Its images, wordplay, and musicality make it possible to tell the city through its own references.\n\nLuga-Flow has given particular visibility to artists who choose to rap, sing, or mix languages without asking permission to sound like somewhere else. Lyrics may explore ambition, love, neighbourhood life, everyday politics, or humour. They can also travel far, even when some listeners are still working out the meaning of a word.\n\nThe music is a reminder that a language does not live only in books or lessons. It lives when people reshape it, make it rhyme, and hear a crowd shout it together. Hearing Luganda in a track is hearing a city speak in its own rhythm."
      }
    ]
  },
  voyages: {
    ...
    stories: [
      {
        ...
        fr: "Avant que la fête ne commence vraiment, la cour s'anime déjà. Les gomesi aux couleurs vives se croisent, les kanzu blancs sont soigneusement ajustés, et l'on attend la famille qui arrive. Chez les Baganda, le Kwanjula est le moment où un homme est présenté officiellement à la famille de la femme qu'il souhaite épouser.\n\nIl ne s'agit pas seulement de deux personnes. La rencontre met aussi en présence deux familles, avec leurs aînés, leurs amis, leurs histoires et leurs attentes. La famille du futur marié apporte des présents préparés avec attention pour les parents et les proches de la mariée. Selon les familles, leur composition et le déroulement de la journée peuvent varier, mais le geste dit la considération et le désir de créer un lien.\n\nLes échanges ont souvent une part de cérémonie et une part de jeu. On se présente, on plaisante, on laisse parfois la parole aux personnes chargées de guider la rencontre. Les ssenga, les tantes paternelles, peuvent accompagner la mariée dans cette période en lui transmettant conseils et repères familiaux. La musique, les salutations et les rires empêchent le moment de devenir trop solennel.\n\nÀ la fin, le Kwanjula laisse davantage qu'un souvenir de beaux vêtements ou de cadeaux alignés. Il marque une porte franchie ensemble : avant le mariage, deux familles ont pris le temps de se voir, de se reconnaître et de faire une place à une nouvelle relation.",
        en: "Before the celebration truly begins, the courtyard is already coming alive. Bright gomesi move past one another, white kanzu are carefully adjusted, and people wait for the arriving family. Among the Baganda, the Kwanjula is the moment when a man is formally introduced to the family of the woman he hopes to marry.\n\nIt is not only about two people. The meeting also brings together two families, with their elders, friends, stories, and expectations. The groom-to-be's family brings gifts chosen with care for the bride's parents and relatives. Their contents and the course of the day may vary from family to family, but the gesture expresses regard and the wish to build a bond.\n\nThe exchanges often combine ceremony and playfulness. People introduce themselves, joke, and sometimes leave the speaking to those appointed to guide the gathering. The ssenga, paternal aunts, may support the bride during this period by passing on advice and family guidance. Music, greetings, and laughter keep the occasion from becoming overly formal.\n\nBy the end, the Kwanjula leaves more than a memory of fine clothes or gifts set out in a row. It marks a threshold crossed together: before the wedding, two families have taken time to meet, recognize one another, and make room for a new relationship."
      },
      {
        title: { fr: "L'Imbalu, le rite de passage des Bagisu", en: "Imbalu, the Bagisu Rite of Passage" },
        fr: "Dans l'est de l'Ouganda, quand les tambours prennent de l'ampleur et que les chants répondent dans les rues, on sait que l'Imbalu approche. Chez les Bagisu, ce rite de circoncision accompagne le passage de jeunes garçons vers l'âge adulte et donne à toute la communauté une raison de se réunir.\n\nLes préparatifs peuvent commencer bien avant le rite lui-même. Les familles reçoivent, les proches encouragent les initiés, et les danses font circuler l'énergie de la fête. Les jeunes hommes, parfois couverts de farine et de cendre, avancent au son des tambours, entourés de parents, d'amis et de voisins.\n\nL'Imbalu demande du courage, et c'est une dimension importante de la manière dont il est vécu. Mais le courage n'est pas présenté comme une affaire solitaire : il se construit dans le regard des aînés, dans les encouragements de la famille et dans l'idée d'entrer avec sérieux dans de nouvelles responsabilités. Les pratiques et les attentes peuvent différer selon les familles et les générations.\n\nPour un visiteur, les tambours et les mouvements de foule sont ce que l'on remarque d'abord. Pour beaucoup de Bagisu, le souvenir le plus profond est aussi celui d'une présence collective : une communauté qui accompagne ses jeunes et leur rappelle que grandir, c'est apprendre à prendre sa place parmi les autres.",
        en: "In eastern Uganda, when the drums gather force and songs answer one another in the streets, people know that Imbalu is approaching. Among the Bagisu, this circumcision rite accompanies boys' passage into adulthood and gives the whole community a reason to come together.\n\nPreparations may begin long before the rite itself. Families receive visitors, relatives encourage the initiates, and dances carry the energy of the celebration. The young men, sometimes covered in flour and ash, move to the sound of drums, surrounded by parents, friends, and neighbours.\n\nImbalu calls for courage, and that is an important part of how it is experienced. Yet courage is not understood as a solitary matter: it is built through elders' presence, a family's encouragement, and the idea of seriously entering new responsibilities. Practices and expectations may differ between families and generations.\n\nFor a visitor, the drums and the moving crowds may be the first things noticed. For many Bagisu, the deeper memory is also one of collective presence: a community accompanying its young people and reminding them that growing up means learning to take one's place among others."
      },
      {
        title: { fr: "L'Empango, le tambour qui couronne un roi", en: "Empango, the Drum That Crowns a King" },
        fr: "Dans le royaume de Tooro, un tambour ne sert pas seulement à donner le rythme. L'Empango est lié à la royauté elle-même : il évoque la continuité du royaume et la dignité du roi, l'Omukama. Quand vient le temps de le célébrer, le son du tambour rassemble bien au-delà d'une simple cérémonie musicale.\n\nLa célébration de l'Empango marque traditionnellement l'anniversaire du couronnement de l'Omukama. À Fort Portal et dans les environs, les préparatifs font place aux tenues cérémonielles, aux danses, aux salutations et à la venue de personnes qui souhaitent prendre part à ce moment du calendrier culturel.\n\nLe tambour porte une valeur symbolique particulière. Il rappelle que le pouvoir royal, dans les royaumes traditionnels ougandais, est aussi entouré de mémoire, de protocoles et de responsabilités. Les détails de la cérémonie sont tenus avec soin par ceux qui en assurent la transmission; ils ne se réduisent pas à un spectacle pour visiteurs.\n\nÉcouter l'Empango, c'est donc entendre plus qu'une percussion. Dans la vibration qui traverse l'assemblée, il y a l'écho d'une institution ancienne qui continue de donner aux habitants de Tooro un langage pour célébrer leur histoire et leur appartenance.",
        en: "In the Kingdom of Tooro, a drum does more than keep time. Empango is bound to kingship itself: it evokes the continuity of the kingdom and the dignity of the king, the Omukama. When the time comes to celebrate it, the drum's sound gathers people for far more than a musical ceremony.\n\nThe Empango celebration traditionally marks the anniversary of the Omukama's coronation. In and around Fort Portal, preparations make room for ceremonial dress, dancing, greetings, and people coming to share this moment in the cultural calendar.\n\nThe drum carries a particular symbolic weight. It recalls that royal authority, in Uganda's traditional kingdoms, is also surrounded by memory, protocol, and responsibility. The ceremony's details are carefully held by those who pass them on; they cannot be reduced to a performance for visitors.\n\nListening to Empango, then, means hearing more than percussion. In the vibration moving through the gathering is the echo of an old institution that still gives people in Tooro a language for celebrating their history and belonging."
      },
      {
        title: { fr: "L'Empaako, le nom qui apaise", en: "Empaako, the Name That Soothes" },
        fr: "Dans les régions de Tooro et de Bunyoro, il arrive qu'une personne soit appelée par un nom qui n'est pas celui inscrit sur ses papiers. Cet empaako est un nom de respect et d'affection, employé pour saluer, apaiser une tension ou simplement rendre la parole plus douce.\n\nLe geste semble simple : appeler quelqu'un par son empaako, attendre la réponse, puis poursuivre la conversation. Pourtant, il rappelle que l'on peut s'adresser à l'autre avec attention, même au milieu d'un désaccord ou d'une journée pressée. Certaines familles transmettent ces usages dès l'enfance; d'autres les rencontrent surtout lors des cérémonies et des retrouvailles.\n\nLes empaako sont associés à un petit ensemble de noms traditionnels et à des formes de salutation partagées dans ces communautés. Ils ne remplacent pas les noms personnels ni toutes les façons ordinaires de se parler. Leur force tient plutôt à ce qu'ils ajoutent à une relation : une marque de reconnaissance qui ouvre un espace plus calme.\n\nPour un apprenant de langues, cette tradition est une belle leçon de nuance. Un nom peut faire plus que désigner quelqu'un. Prononcé au bon moment, avec respect, il peut rapprocher deux personnes et changer le ton de toute une conversation.",
        en: "In the Tooro and Bunyoro regions, a person may be called by a name that is not the one written on their documents. This empaako is a name of respect and affection, used to greet someone, ease a tension, or simply make speech gentler.\n\nThe gesture seems simple: call someone by their empaako, wait for the response, then continue the conversation. Yet it suggests that people can address one another with care, even during a disagreement or a hurried day. Some families pass these customs on from childhood; others encounter them mainly at ceremonies and reunions.\n\nEmpaako are associated with a small set of traditional names and shared forms of greeting in these communities. They do not replace personal names or every ordinary way of speaking. Their strength lies instead in what they add to a relationship: a mark of recognition that opens a calmer space.\n\nFor a language learner, this tradition offers a lovely lesson in nuance. A name can do more than identify someone. Spoken at the right moment, with respect, it can bring two people closer and change the tone of an entire conversation."
      },
      {
        title: { fr: "La Ssenga, gardienne des femmes baganda", en: "The Ssenga, a Guide for Baganda Women" },
        fr: "Dans beaucoup de familles baganda, la ssenga — la tante paternelle — est une présence que l'on écoute avec une attention particulière. Son rôle est souvent évoqué à l'approche d'un mariage, lorsque la future mariée reçoit des conseils sur la vie de couple, les relations familiales et la façon d'entrer dans une nouvelle étape.\n\nCes conversations se tiennent rarement comme un cours. Elles peuvent prendre la forme d'un moment à la maison, d'une préparation partagée ou d'un échange plus discret entre femmes de la famille. La ssenga transmet des repères, mais elle écoute aussi; son accompagnement dépend des personnes, des familles et de leur manière de faire vivre la tradition aujourd'hui.\n\nSon importance ne signifie pas que toutes les femmes baganda ont la même expérience, ni que les conseils d'une génération s'appliquent sans discussion à la suivante. Comme ailleurs, les attentes autour du mariage et de l'autonomie évoluent. La figure de la ssenga reste néanmoins une façon reconnue de prendre au sérieux la préparation affective et familiale d'une jeune femme.\n\nDans le tumulte d'une grande cérémonie, on ne voit pas toujours ce travail de transmission. Pourtant, derrière une mariée entourée des siens, il peut y avoir ces paroles patientes, ces questions posées sans jugement et cette idée simple : on n'entre pas seule dans une nouvelle vie.",
        en: "In many Baganda families, the ssenga—the paternal aunt—is a person whose words are heard with particular attention. Her role is often mentioned as a wedding approaches, when the bride-to-be receives guidance about married life, family relationships, and entering a new stage of life.\n\nThese conversations rarely take the form of a lesson. They may happen at home, during a shared preparation, or in a more private exchange among women in the family. The ssenga passes on guidance, but she also listens; her support depends on the people involved, their families, and the way they keep the tradition alive today.\n\nHer importance does not mean that all Baganda women have the same experience, or that one generation's advice applies to the next without discussion. As elsewhere, expectations around marriage and independence change. The figure of the ssenga nevertheless remains a recognized way of taking a young woman's emotional and family preparation seriously.\n\nIn the bustle of a large ceremony, this work of passing things on is not always visible. Yet behind a bride surrounded by her people, there may be patient words, questions asked without judgment, and one simple idea: no one enters a new life alone."
      },
      {
        title: { fr: "Okwalula Abalongo, la cérémonie des jumeaux", en: "Okwalula Abalongo, the Twins' Ceremony" },
        fr: "La naissance de jumeaux change le rythme d'une famille. Dans le Buganda, elle peut aussi appeler Okwalula Abalongo, une cérémonie qui reconnaît les jumeaux et rassemble les proches autour de leur arrivée. Les enfants ne sont pas seulement accueillis comme deux nouveau-nés : ils donnent lieu à une attention et à une joie particulières.\n\nLa famille prépare la rencontre, reçoit les visiteurs et partage un temps de célébration où chants, danses et gestes symboliques peuvent avoir leur place. Les formes exactes varient, car les familles ne vivent pas toutes la tradition de la même manière. Ce qui demeure, c'est le désir d'entourer les enfants et leurs parents d'une communauté présente.\n\nLa cérémonie rend aussi visible le réseau de parenté qui se met en mouvement autour d'eux. Aînés, voisins et amis viennent féliciter, aider ou simplement être là. Dans une vie quotidienne où les parents peuvent se sentir vite débordés, cette présence collective donne une forme concrète à la solidarité familiale.\n\nOkwalula Abalongo rappelle qu'une naissance peut être à la fois intime et partagée. Au milieu des voix, des rires et des salutations, les jumeaux commencent leur histoire dans un cercle plus large que leur foyer : celui des liens qui les accueilleront en grandissant.",
        en: "The birth of twins changes a family's rhythm. In Buganda, it may also call for Okwalula Abalongo, a ceremony that recognizes the twins and gathers relatives around their arrival. The children are not simply welcomed as two newborns: their birth receives particular attention and joy.\n\nThe family prepares for the gathering, welcomes visitors, and shares a time of celebration in which songs, dances, and symbolic gestures may have a place. The exact forms vary, because families do not all live the tradition in the same way. What remains is the wish to surround the children and their parents with a present community.\n\nThe ceremony also makes visible the network of kinship that begins moving around them. Elders, neighbours, and friends come to congratulate, help, or simply be there. In everyday life, when parents can quickly feel overwhelmed, this collective presence gives family solidarity a concrete shape.\n\nOkwalula Abalongo reminds us that a birth can be both intimate and shared. Among voices, laughter, and greetings, the twins begin their story in a circle wider than their home: the circle of bonds that will welcome them as they grow."
      },
      {
        title: { fr: "Okwabya Olumbe, les derniers rites funéraires", en: "Okwabya Olumbe, the Final Funeral Rites" },
        fr: "Après un décès, le silence d'une maison ne s'efface pas en un jour. Dans le Buganda, Okwabya Olumbe désigne les derniers rites funéraires, un temps organisé après les funérailles pour accompagner la fin du deuil et réunir de nouveau la famille autour de ce qui doit continuer.\n\nLes proches se rassemblent pour se souvenir de la personne disparue, accueillir ceux qui viennent partager leur peine et accomplir les gestes qui donnent à cette période une conclusion collective. C'est un moment chargé d'émotion, mais aussi de conversations pratiques : une famille doit souvent se réorganiser après la perte de l'un des siens.\n\nSelon les circonstances et les lignées, la cérémonie peut aussi permettre de reconnaître la personne appelée à reprendre certaines responsabilités familiales. Cette reconnaissance d'un héritier ne se limite pas aux biens. Elle parle de continuité, de devoirs envers les proches et de la nécessité de veiller sur ce qui a été confié par les générations précédentes.\n\nLe deuil ne disparaît pas parce qu'une cérémonie s'achève. Pourtant, Okwabya Olumbe offre un seuil : la famille peut quitter le temps des rites les plus intenses sans oublier, et avancer avec la mémoire de la personne disparue toujours présente parmi elle.",
        en: "After a death, the silence in a home does not disappear in a day. In Buganda, Okwabya Olumbe refers to the final funeral rites, a time arranged after the burial to accompany the close of mourning and bring the family together again around what must continue.\n\nRelatives gather to remember the person who has died, welcome those who come to share their grief, and carry out the gestures that give this period a collective conclusion. It is an emotional time, but also one for practical conversations: a family often has to reorganize after losing one of its own.\n\nDepending on the circumstances and lineage, the ceremony may also recognize the person called to take on certain family responsibilities. This recognition of an heir is not limited to property. It speaks of continuity, duties toward relatives, and the need to care for what previous generations have entrusted.\n\nGrief does not disappear because a ceremony ends. Yet Okwabya Olumbe offers a threshold: the family can leave the time of the most intense rites without forgetting, and move forward with the memory of the person who died still present among them."
      },
      {
        title: { fr: "L'Akiriket, le conseil des anciens karimojong", en: "Akiriket, the Karimojong Council of Elders" },
        fr: "Dans les plaines de Karamoja, les troupeaux rythment les journées autant que les saisons. On parle de pâturages, de pluie, de sécurité et des chemins à suivre. Au cœur de cette vie pastorale, l'Akiriket est le conseil des anciens karimojong : un lieu de parole où l'expérience a une valeur concrète pour la communauté.\n\nLes anciens y discutent des affaires qui touchent la vie collective et transmettent des connaissances façonnées par le territoire. Savoir lire les saisons, prendre soin du bétail, entretenir des relations entre familles ou apaiser un conflit ne relève pas seulement d'une règle écrite; ce sont aussi des savoirs qui se construisent en écoutant ceux qui ont vécu longtemps avec cette terre.\n\nL'Akiriket est lié à une société où les générations et les étapes de la vie comptent beaucoup. Les jeunes apprennent en observant, en participant et en entendant les récits des aînés. Les pratiques ne sont pas immobiles : comme toute communauté, les Karimojong vivent des changements et discutent de la façon de préserver ce qui leur importe.\n\nPour comprendre ce conseil, il faut imaginer plus qu'un cercle de vieillards assis à l'écart. Il faut entendre une mémoire en action, mise au service du présent : des voix qui cherchent à guider la communauté afin que le savoir, comme un troupeau confié aux siens, puisse continuer son chemin.",
        en: "On the plains of Karamoja, herds set the rhythm of days as much as the seasons do. People speak of grazing land, rain, safety, and the paths to follow. At the heart of this pastoral life, Akiriket is the Karimojong council of elders: a place of discussion where experience has practical value for the community.\n\nThere, elders discuss matters affecting collective life and pass on knowledge shaped by the land. Knowing how to read the seasons, care for livestock, maintain relationships between families, or ease a conflict is not only a matter of written rules; it is also knowledge built by listening to people who have lived with this land for a long time.\n\nAkiriket is connected to a society in which generations and stages of life matter deeply. Young people learn by observing, taking part, and hearing elders' stories. The practices are not fixed: like every community, the Karimojong live through change and discuss how to preserve what matters to them.\n\nTo understand this council, it helps to picture more than a circle of old men sitting apart. It is memory in action, serving the present: voices seeking to guide the community so that knowledge, like a herd entrusted to its people, can continue on its way."
      }
    ]
  },
  celebration: {
